...
FeraligatrFrontpic:  INCBIN "gfx/pokemon/feraligatr/front_gold.2bpp.lz.bin"
...
SneaselFrontpic:     INCBIN "gfx/pokemon/sneasel/front.2bpp.lz.bin"
...
QwilfishBackpic:     INCBIN "gfx/pokemon/qwilfish/back.2bpp.lz.bin"
...
PupitarBackpic:      INCBIN "gfx/pokemon/pupitar/back.2bpp.lz.bin"
KoffingBackpic:      INCBIN "gfx/pokemon/koffing/back.2bpp.lz"


SECTION "Pics 6", ROMX

GirafarigBackpic:    INCBIN "gfx/pokemon/girafarig/back.2bpp.lz.bin"
...
FlaaffyBackpic:      INCBIN "gfx/pokemon/flaaffy/back.2bpp.lz.bin"
PinsirBackpic:       INCBIN "gfx/pokemon/pinsir/back.2bpp.lz.bin"
...
JynxFrontpic:        INCBIN "gfx/pokemon/jynx/front_gold.2bpp.lz.bin"
...
OfficerPic:          INCBIN "gfx/trainers/officer.2bpp.lz.bin"
...
LanturnFrontpic:     INCBIN "gfx/pokemon/lanturn/front_gold.2bpp.lz.bin"
...
SneaselBackpic:      INCBIN "gfx/pokemon/sneasel/back.2bpp.lz.bin"
...
SlugmaBackpic:       INCBIN "gfx/pokemon/slugma/back.2bpp.lz.bin"
...
AipomFrontpic:       INCBIN "gfx/pokemon/aipom/front_gold.2bpp.lz.bin"
...
MistyPic:            INCBIN "gfx/trainers/misty.2bpp.lz.bin"
...
BlainePic:           INCBIN "gfx/trainers/blaine.2bpp.lz.bin"
...
SunkernBackpic:      INCBIN "gfx/pokemon/sunkern/back.2bpp.lz.bin"
...
PolitoedBackpic:     INCBIN "gfx/pokemon/politoed/back.2bpp.lz.bin"
...
ExecutivefPic:       INCBIN "gfx/trainers/executive_f.2bpp.lz.bin"
PichuBackpic:        INCBIN "gfx/pokemon/pichu/back.2bpp.lz.bin"
...
PrycePic:            INCBIN "gfx/trainers/pryce.2bpp.lz.bin"
LanturnBackpic:      INCBIN "gfx/pokemon/lanturn/back.2bpp.lz.bin"
BrockPic:            INCBIN "gfx/trainers/brock.2bpp.lz.bin"
...
SagePic:             INCBIN "gfx/trainers/sage.2bpp.lz.bin"
...
WooperBackpic:       INCBIN "gfx/pokemon/wooper/back.2bpp.lz.bin"
...
PichuFrontpic:       INCBIN "gfx/pokemon/pichu/front_gold.2bpp.lz.bin"
BulbasaurFrontpic:   INCBIN "gfx/pokemon/bulbasaur/front_gold.2bpp.lz.bin"
SwinubBackpic:       INCBIN "gfx/pokemon/swinub/back.2bpp.lz"
TangelaBackpic:      INCBIN "gfx/pokemon/tangela/back.2bpp.lz"
IgglybuffFrontpic:   INCBIN "gfx/pokemon/igglybuff/front_gold.2bpp.lz.bin"
SpinarakFrontpic:    INCBIN "gfx/pokemon/spinarak/front.2bpp.lz.bin"
GolemBackpic:        INCBIN "gfx/pokemon/golem/back.2bpp.lz"
MantineBackpic:      INCBIN "gfx/pokemon/mantine/back.2bpp.lz"
HorseaFrontpic:      INCBIN "gfx/pokemon/horsea/front_gold.2bpp.lz.bin"
PiloswineBackpic:    INCBIN "gfx/pokemon/piloswine/back.2bpp.lz"
KakunaFrontpic:      INCBIN "gfx/pokemon/kakuna/front_gold.2bpp.lz.bin"
SwinubFrontpic:      INCBIN "gfx/pokemon/swinub/front.2bpp.lz.bin"
NatuBackpic:         INCBIN "gfx/pokemon/natu/back.2bpp.lz"
OddishFrontpic:      INCBIN "gfx/pokemon/oddish/front_gold.2bpp.lz.bin"
DiglettFrontpic:     INCBIN "gfx/pokemon/diglett/front_gold.2bpp.lz.bin"
DiglettBackpic:      INCBIN "gfx/pokemon/diglett/back.2bpp.lz"
UnownCFrontpic:      INCBIN "gfx/pokemon/unown_c/front.2bpp.lz.bin"
TogepiFrontpic:      INCBIN "gfx/pokemon/togepi/front_gold.2bpp.lz.bin"
MetapodFrontpic:     INCBIN "gfx/pokemon/metapod/front_gold.2bpp.lz.bin"
JynxBackpic:         INCBIN "gfx/pokemon/jynx/back.2bpp.lz.bin"
...
BikerPic:            INCBIN "gfx/trainers/biker.2bpp.lz.bin"
...
StantlerFrontpic:    INCBIN "gfx/pokemon/stantler/front_gold.2bpp.lz.bin"
ExeggutorFrontpic:   INCBIN "gfx/pokemon/exeggutor/front_gold.2bpp.lz"
BrunoPic:            INCBIN "gfx/trainers/bruno.2bpp.lz.bin"
...
HikerPic:            INCBIN "gfx/trainers/hiker.2bpp.lz.bin"
...
MediumPic:           INCBIN "gfx/trainers/medium.2bpp.lz.bin"
...
FisherPic:           INCBIN "gfx/trainers/fisher.2bpp.lz.bin"
...
PokefanmPic:         INCBIN "gfx/trainers/pokefan_m.2bpp.lz.bin"
BoarderPic:          INCBIN "gfx/trainers/boarder.2bpp.lz.bin"
